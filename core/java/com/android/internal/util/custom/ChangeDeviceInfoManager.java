...
public class ChangeDeviceInfoManager {
    private static final String TAG = "ChangeDeviceInfoManager";
    private static final String DATA_PIF = ReadFileData.readFile("deviceinfo.json");
